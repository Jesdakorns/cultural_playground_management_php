            ...
            <h1 class="bg_header">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-">
                        ...
                        <!-- <h1 class="bg_header text-center">
                        <button type="button" class="btn btn-volue-up overlay-text3"><i class="fas fa-volume-up"></i></button>
                        <button type="button" class="btn btn-volue-mute overlay-text2"><i class="fas fa-volume-mute"></i></button> 
                    </h1> -->
                    </div>
